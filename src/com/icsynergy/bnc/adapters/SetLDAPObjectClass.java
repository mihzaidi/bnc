...
public class SetLDAPObjectClass {
    ...
    public String setObjectClasses(long lProcInstKey, String strLookupName)
        ...
        try {
            ...
            final String strConfigLookup = getParamForItRes(strItResKey, "Configuration Lookup");
    ...
    private void addObjClasses(DirContext ctx, String strUUID, Set<String> setToAdd) throws NamingException {
        ...
        NamingEnumeration<SearchResult> searchResults = ctx.search("", String.format("%s=%s", UUID, strUUID), ctls);
    ...
    private String getParamForItRes(String strItResKey, String strParam)
        ...
        log.entering(getClass().getName(), "getConfigLookupForItRes", strItResKey + " " + strParam);
        ...
        log.exiting(getClass().getName(), "getConfigLookupForItRes", strRet);
        return strRet;
    }
}
